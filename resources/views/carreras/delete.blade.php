...
@php
    $delete_carrera=session("delete_carrera");//declarar variable para utilizar valores en la sesion
@endphp
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      Deseas eliminar el registro de nombre {{$delete_carrera->descripcion_carrera}}
    </div>
