...
<div class="modal fade" id="modal-edit" role="dialog">
    <div class="modal-dialog">
        ...
        @endphp
            ...
            <!-- Modal content-->
        <form method="POST"  action="{{url('/personas/'.(isset($edit_persona->id_personas) ? $edit_persona->id_personas : $edit_persona["id_personas"]))}}" role="form" enctype="multipart/form-data">
            <div class="modal-content">
                <input type="hidden" value="{{isset($edit_persona->id_personas) ? $edit_persona->nombre : $edit_persona["id_personas"]}}" name="id_persona">
                                        ...
                                        <div class="box box-info padding-1">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($errors->has('estado_civil')) {{--creacion de un span en caso de existir error--}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_carrera" class="form-control{{$errors->has('id_carrrera') ? ' is-invalid' : ''}}" placeholder="Carrera">
                                                        @foreach($datos_carreras as $carrera)
                                                           <option value="{{$carrera->id_carrera}}" {{(isset($edit_persona->id_carrera) ? $edit_persona->id_carrera: $edit_persona["id_carrera"]) == $carrera->id_carrera ? "selected":""}}>{{$carrera->descripcion_carrera}}</option>
                                                        @endforeach
                                                    </select>
